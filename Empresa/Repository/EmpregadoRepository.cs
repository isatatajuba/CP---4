...
public class EmpregadoRepository : IEmpregadoRepository
{
    ...
    public async Task<Empregado> AssociateEmpregadoToDepartamento(int EmpregadoId, int IdDepartament)
    {
        ...
        empregado.IdDepartament = IdDepartament;
    ...
    public async Task<Empregado> UpdateEmpregado(Empregado empregado)
    {
        ...
        existingEmpregado.IdDepartament = empregado.IdDepartament; // Atualiza a chave estrangeira se necessário
